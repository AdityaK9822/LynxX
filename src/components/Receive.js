...
export default function Receive({ address }) {
    ...
    return (
        <div 
            className="receive-container-outer" 
            style={{ 
                position: 'relative',
                maxWidth: '860px', 
                margin: '0 auto', 
        ...
        >
            {/* Background Image Placed OUTSIDE the Cards across full Page Background */}
            <Image
                src={mainBG}
                alt="LynxX Background Image"
                fill
                priority
                aria-hidden="true"
                style={{ objectFit: 'cover', objectPosition: 'center', opacity: 0.25, pointerEvents: 'none', zIndex: 0 }}
            />
            ...
            <div style={{ position: 'relative', zIndex: 2, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px' }}>
                ...
                {/* Right Glass Card: Address & Actions */}
                <div 
                    className="escrow-card" 
                    style={{ 
                        display: 'flex', 
